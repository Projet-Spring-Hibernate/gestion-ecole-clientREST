...
<body>
	...
	<div class="mainContent">
		...
		<form:form modelAttribute="adresse" method="POST"
			action="${pageContext.request.contextPath}/adresses/add">


			<table class="table">

				<tr>
					<td><form:label path="rue">Nom :</form:label></td>
					<td><form:input path="rue" /></td>

				</tr>
				<tr>
					<td><form:label path="codePostal">Prenom :</form:label></td>
				...
				<tr>
					<td><form:label path="ville">Email :</form:label></td>
