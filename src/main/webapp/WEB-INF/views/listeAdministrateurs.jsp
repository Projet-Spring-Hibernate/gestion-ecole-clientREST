...
<br/>
	<div class="mainContent">
		...
		<a
			...
			class="btn btn-primary btn-sm" role="button">Ajouter un administrateur</a>
		<br /> <br />
		<table class="table table-striped">
			...
			<c:forEach items="${attribut_liste_administrateurs}" var="admin">
				<tr>
...
<!-- 					colonne pour la modif de l'etudiant -->
					<td><a 
						href="${pageContext.request.contextPath}/administrateurs/update-administrateurs-form/${admin.identifiant}">Modifier</a></td>

					<!-- colonne pour la suppression du cours -->
					<td><a
						href="${pageContext.request.contextPath}/administrateurs/supprimer/${admin.identifiant}">Supprimer</a></td>
